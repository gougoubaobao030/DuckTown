...
项目以“在复现经典rpg基本功能的基础上，以真实可用的系统架构”为目标，涵盖了技能系统、状态机、AI怪物、商店系统、背包金币系统、对话任务、等多个模块。
展示基本需求制作能力，自学条件的下的系统架构理解能力与追求完整开发流程能力。
以及作者对游戏制作的热情和真心
...
不同于纯展示型的教学 Demo，本制作完全不依赖教程，完全不依赖教程！
在大量资料查阅，大量Ai辅助下逐步迭代推进。
本项目在系统划分、模块通信、数据结构设计方面进行了大量实践，目标是达到“能体验公司实战项目难度、七八成规范”。同时，尝试站在未来团队协作与功能拓展的角度思考，设计合理的系统边界与职责。
...
- 🧠 **Ai精英怪以及经验小怪系统**
  - 精英怪拥有 Idle / Move / 巡逻 /跟踪 /攻击 /随机连招攻击 等状态
  - 采用对象池管理血条UI，怪物的死亡和再生
  - 采用动画系统采用关键帧攻击保证游戏手感
...
## ✅ 2025年8月24日 更新日志
- 技能系统模块完成（Skill System Module）
- AI敌人系统升级（Enhanced Enemy AI System）
- 血条与伤害显示系统优化
- 全局对象池实装并优化技能敌人

## 2025年8月25日
- 将背包物品改为可堆叠，并修复对象池问清空问题

## 2025年9月1日
- 增加技能伤害数据，精英怪血条根据实际技能伤害扣血

## ✅ 2026年2月26日 更新日志
- 新增采集系统 并有采集进度条 可被攻击打断 自己远离打断能功能
- 新增简单对话和简单任务系统 包含任务状态管理和各模块数据通信
- 修复多种显示Bug